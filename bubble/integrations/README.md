...
│   └── cli.py           # `bubble django` subcommands
│
...
from bubble.integrations.myframework.detector import detect_myframework_entrypoints
from bubble.integrations.myframework.semantics import EXCEPTION_RESPONSES
...
class MyFrameworkIntegration:
    ...
    @property
    def cli_app(self) -> typer.Typer:
        from bubble.integrations.myframework.cli import app
        return app
...
from bubble.integrations.myframework import MyFrameworkIntegration
from bubble.integrations.queries import audit_integration, list_integration_entrypoints
